...
public class MssqlDiffTableCreate(DiffTableCreate diff)
    : BaseMssqlDiffBlock<DiffTableCreate>(diff)
{
    private static void appendFieldSql(FieldModel fld, ISqlFileBuilder sb)
    {
        ...
        else
        {
            ...
            sb.AppendIf(() => " COLLATE " + fld.Collation, fld.Collation != null)
                .Append(!fld.Nullable ? " NOT NULL" : " NULL")
