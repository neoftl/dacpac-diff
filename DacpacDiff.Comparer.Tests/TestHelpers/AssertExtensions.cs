...
{
    public static void LinesEqual(this Assert _, string[] expected, string actual)
    {
        CollectionAssert.AreEqual(expected, actual.Split(new[] { '\r', '\n' }, StringSplitOptions.RemoveEmptyEntries), actual);
    }
