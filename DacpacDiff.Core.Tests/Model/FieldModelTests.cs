...
namespace DacpacDiff.Core.Model.Tests
{
    ...
    public class FieldModelTests
    {
        ...
        [TestMethod]
        public void IsDefaultMatch__Both_null__True()
        {
            // Arrange
            var p1 = new FieldModel(TableModel.Empty, "Field1");

            var p2 = new FieldModel(TableModel.Empty, "Field2");
        ...
        [DataRow("Def", null)]
        [DataRow("Def1", "Def2")]
        public void IsDefaultMatch__Different_names__False(string lDefName, string rDefName)
        {
            // Arrange
            var p1 = new FieldModel(TableModel.Empty, "Field1");
            p1.Default = new FieldDefaultModel(p1, lDefName, "Value");

            var p2 = new FieldModel(TableModel.Empty, "Field2");
            p2.Default = new FieldDefaultModel(p2, rDefName, "Value");
        ...
        [DataRow("", "")]
        [DataRow("A()B[]C D\rE\nF\tG", "abcdefg")]
        public void IsDefaultMatch__Both_similar__True(string lDefValue, string rDefValue)
        {
            // Arrange
            var p1 = new FieldModel(TableModel.Empty, "Field1");
            p1.Default = new FieldDefaultModel(p1, null, lDefValue);

            var p2 = new FieldModel(TableModel.Empty, "Field2");
            p2.Default = new FieldDefaultModel(p2, null, rDefValue);
        ...
        [DataRow("", "B")]
        [DataRow("A", "B")]
        public void IsDefaultMatch__Different__False(string lDefValue, string rDefValue)
        {
            // Arrange
            var p1 = new FieldModel(TableModel.Empty, "Field1");
            p1.Default = new FieldDefaultModel(p1, null, lDefValue);
