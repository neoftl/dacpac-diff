...
public class CollectionExtensionsTests
{
    ...
    {
        // Arrange
        var values = new[] { a, b, c }.Take(count).ToArray();
    ...
    {
        // Act
        var res = ((IDictionary<string, object>?)null).Merge([]);
    ...
    public void Merge_2__Null_arg__Noop()
    {
        ...
        // Act
        var res = dict.Merge((IDictionary<string, object>?)null, null!, null!)!;
    ...
    {
        // Act
        var res = ((object[]?)null).TryGetValue(null!, out var value);
