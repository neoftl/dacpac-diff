...
namespace DacpacDiff.Mssql.Diff.Tests
{
    ...
    public class MssqlDiffFieldAlterTests
    {
        ...
        public void MssqlFieldAlter__Add_unnamed_default(bool nullable)
        {
            ...
            lft.Default = new FieldDefaultModel(lft, null, "LDefValue");
        ...
        public void MssqlFieldAlter__Add_unnamed_default_and_change_signature()
        {
            ...
            // Assert
            Assert.AreEqual("ALTER TABLE [LSchema].[LTable] ALTER COLUMN [LField] LType DEFAULT (LDefValue) NULL", res);
        }
        ...
        public void MssqlFieldAlter__Add_named_default(bool nullable)
        {
            ...
            lft.Default = new FieldDefaultModel(lft, "LDefault", "LDefValue");
        ...
        public void MssqlFieldAlter__Add_unnamed_reference()
        {
            ...
            var tgt = new FieldModel(new TableModel(new SchemaModel(DatabaseModel.Empty, "TSchema"), "TTable"), "TField");
            lft.Ref = new FieldRefModel(lft, tgt);
        ...
        public void MssqlFieldAlter__Remove_unnamed_reference()
        {
            ...
            var tgt = new FieldModel(new TableModel(new SchemaModel(DatabaseModel.Empty, "TSchema"), "TTable"), "TField");
            rgt.Ref = new FieldRefModel(rgt, tgt);
        ...
        {
            // Arrange
            var lft = new FieldModel(new TableModel(new SchemaModel(DatabaseModel.Empty, "XSchema"), "XTable"), "XField")
            {
                Type = "XType"
            };
